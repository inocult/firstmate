...
#
# The xo-secondmate-parent.v1 record contains exactly one schema and route.
...
# Writers publish this record before .xo-secondmate-home so that the identity
# marker remains the seed-completion point.

xo_secondmate_parent_record_parse() {
  ...
  XO_SECONDMATE_PARENT_ROUTE=
  XO_SECONDMATE_PARENT_HOME=
  XO_SECONDMATE_PARENT_HOST=
  ...
  XO_SECONDMATE_PARENT_ROUTE=$route
  XO_SECONDMATE_PARENT_HOST=$parent_host
}

...
const READY_SCHEMA = "xo.extension-invocation-ready.v1";
const OWNER_SCHEMA = "xo.extension-invocation-owner.v1";
const RELEASE_SCHEMA = "xo.extension-invocation-release.v1";

...
(bin/backends/herdr.sh xo_backend_herdr_wait_transition). It deliberately does
NOT know xo's supervision policy: it opens ONE connection to a herdr
...
shape and applies the single-owner policy table (bin/xo-transition-lib.sh); the

...
This helper is the wire transport for XO's optional presentation-only
...
Wire protocol verified against Herdr 0.7.4, protocol 16:
  ...
  request:  {"id":"xo-workspace-move","method":"workspace.move",
             "params":{"workspace_id":W,"insert_index":N}}\n
  response: {"id":"xo-workspace-move","result":

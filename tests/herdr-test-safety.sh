...
herdr_refuse_if_default() { # <session>
  xo_herdr_lab_refuse_if_default "$1"
}

herdr_safe_stop_and_delete() { # <session>
  xo_herdr_lab_teardown "$1"
}

...
test_skills_activation_links_checked_out_as_files_are_reported() {
  ...
  mkdir -p "$case_dir/home/config" "$case_dir/home/.agents/skills" "$case_dir/home/skills/core/ahoy" "$case_dir/home/skills/core/stow"
  printf '%s\n' manual > "$case_dir/home/config/backlog-backend"
  : >"$case_dir/home/skills/core/ahoy/SKILL.md"
  : >"$case_dir/home/skills/core/stow/SKILL.md"
  ln -s ../../skills/core/ahoy "$case_dir/home/.agents/skills/ahoy"
  ln -s ../../skills/core/stow "$case_dir/home/.agents/skills/stow"
  ...
  mkdir -p "$case_dir/home/config" "$case_dir/home/.agents/skills" "$case_dir/home/skills/core/ahoy"
  printf '%s\n' manual > "$case_dir/home/config/backlog-backend"
  : >"$case_dir/home/skills/core/ahoy/SKILL.md"
  ln -s ../../skills/core/ahoy "$case_dir/home/.agents/skills/ahoy"
  fakebin=$(make_fake_toolchain "$case_dir")

...
Removed from upstream: the assignee-based claim, because this project's human assignees are never modified; and charting's research dispatch, because it would have this session commit inside a project.

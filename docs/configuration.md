...
11. Update the origin remote with `git remote set-url origin` to the renamed repository URL, in the primary home and in every secondmate home that clones from it.

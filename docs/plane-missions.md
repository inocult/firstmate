...
The [Overwatch skill](../skills/missions/overwatch/SKILL.md) owns the pickup policy, recovery and watcher integration.
The [Breach skill](../skills/missions/breach/SKILL.md) owns the attributed adaptation of Pocock's implementation entrypoint.
...
The [prep skill](../skills/missions/prep/SKILL.md) owns the setup procedure: `/prep` walks it end to end, preparing this home and commissioning the repository's own documentation through a worker on the project's delivery path.

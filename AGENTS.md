...
skills/              canonical skill source, skills/<category>/<name>/SKILL.md, committed; categories public, station, missions, experimental, and deprecated per docs/configuration.md; a name may exist once in an internal category such as station and once in public as two audience variants, and the activation link picks the loaded one

// XO's Calm-only animated working presentation.
//
...
// temporary TUI widget; `.pi/extensions/xo-calm.ts` owns when the presentation is
...
export const CALM_WORKING_SHIP_WIDGET_KEY = "xo-calm-working-ship";

...
function runGuard(root) {
  ...
  return runProcess(`${root}/bin/xo-turnend-guard.sh`, [], '{"stop_hook_active":false}');
}
...
export const XoPrimaryTurnendGuard = async ({ client, directory, worktree }) => {
  ...
  return {
    event: async ({ event }) => {
      ...
      try {
        const text = await encodeXoOperationalInput(
          root,
          "turn-end-guard",

...
<!-- maintainers: this is the public, installer-facing skill. Keep it standalone, with no private project paths, tool assumptions, or environment branching. The XO-internal counterpart lives at skills/orders/stow/SKILL.md - deliberately a separate file with no shared code. Keep them independent. -->
